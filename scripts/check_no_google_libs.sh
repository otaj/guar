...
#
# Layer A — Gradle {debug,release}RuntimeClasspath must not resolve:
...
APP_ANDROID="${ROOT}/packages/guar/android"
# Match unsigned/debug CI vs signed release builds.
GRADLE_CONFIGURATION="${GRADLE_CONFIGURATION:-releaseRuntimeClasspath}"
