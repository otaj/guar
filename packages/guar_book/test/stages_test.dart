...
''';
    final ledger = const Book().process(const p.BeancountParser().parse(source, filename: 'pad.beancount'));
...
2020-01-02 balance Assets:Checking 100.00 USD
''';
    final ledger = const Book().process(const p.BeancountParser().parse(source, filename: 'bal.beancount'));
